...
Le notebook principal est notebooks.ipynb

Le dossier src contient tout les modules utilisés dans le notebook.

Dans le dossier src, 
- le module get_data.py permet d'extraire les données,
- le module analyse_data.py permet d'analyser les données en vue de faciliter le nettoyage
